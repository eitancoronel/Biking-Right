...
int movingAveregeData[movingAveregeRange] = {10,10,10,10,10,10,10,10,10,10};
const int colorAveregeRange = 30;
int colorAveregeData[colorAveregeRange] = {0};
float colorAverege = 0;
...
void calcColorAveregeByPeaks(){
  ...
  Serial.println(sum / colorAveregeRange);
...
void tests(){
  ...
  Serial.println(currentReading);  // print curr val from left foot
  Serial.print(", right val is : ");
  Serial.println(rightReading);  // print curr val from right foot
}
